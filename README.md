...
Right now I learn Xitsonga by reading the bilingual corpus of 170k sentences: 
- https://xitsonga.vercel.app/

I annotate it to preserve my understanding of the structure and track my progress.
...
I create bite-size programming tasks so that teachers can teach algorithmic thinking as early as to 10yo students. In fact, some of it is possible with 7yo students. I talk about "repeat N times" loop, nested loops, conditions (if, and/or), variables, while loop, functions with parameters.
